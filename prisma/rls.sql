...
-- Gerado por scripts/apply-rls.js (69 tabelas).
...
ALTER TABLE public."AvaliacaoGoogle" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."CampanhaDoPremio" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."CaseContato" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."ImagemDoDossie" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."ImpactRecord" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."ImpactType" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."ItemDeDisparo" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."LoteDeDisparo" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."NpsNote" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."SaudeDaIA" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."TentativaDeLogin" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."WootricSync" ENABLE ROW LEVEL SECURITY;
