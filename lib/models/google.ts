 ...
 *
 * **Sem Gmail, por decisão do Isaac.** A leitura do e-mail
 * (`gmail.readonly`) chegou a existir, para criar a reclamação a partir
 * do aviso que o Reclame Aqui manda. Em 11/09/2026 ele recusou: não quer
 * a plataforma lendo a caixa de ninguém. A reclamação nova entra pela
 * extensão, que confere a lista do portal no navegador de quem está
 * logado — ver `extensao/conteudo/vigia.js`.
 */
